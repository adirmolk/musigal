...
const FriendsList = () => {
  ...
  const formatTimeDifference = (timestamp) => {
    ...
    if (daysDifference > 0) {
      ...
      return <span style={{color:"blue",fontWeight:"bold", fontSize:"14px"}}>now</span>;
    }
  };
  ...
  return (
    ...
    <div className="d-flex align-items-center">
      <button className="btn p-2 mx-4" onClick={toggleFriends}>
        <img
          width={"30px"}
          src="friends (1).png"
          alt="Friends"
              ...
              >
                ...
                <div className="d-flex flex-column">
                  <div className="d-flex align-items-center flex-grow-1">
                    ...
                    <span style={{ fontSize: "14px" }} className="text-muted mb-2">
                  ...
                  >
                    ...
                    <div className="flex-grow-1">
                      ...
                      <p className="text-muted">💿{friend.track.album.name}</p>
                    </div>
                    <SongRating />
                  </div>
                </div>
