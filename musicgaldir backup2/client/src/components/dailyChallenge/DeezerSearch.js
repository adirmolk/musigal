...
const DeezerSearch = ({ onAlbumTitleChange, songs, correctSongIndex, onWin }) => {
  ...
  const [searchAlbumId, setSearchAlbumId] = useState(null);
  ...
  const fetchDeezerData = async () => {
    const options = {
      ...
      headers: {
        "X-RapidAPI-Key":
          "f2954e8161mshe367dd9c79a3865p17b030jsnd10838d0ffa3",
                ...
                <div className="mt-2" style={{ flex: 1 }}>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setSearchSongId(result.id);
                      setSearchAlbumId(result.album.id);
