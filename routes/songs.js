...
router.get("/",auth, async(req,res) => {
  ...
  router.put("/:id", auth, async (req, res) => {
    ...
    try{
      ...
      const data = await songModel.updateOne({_id:id,user_id:req.tokenData._id}, req.body);
  ...
  router.delete("/:id", auth, async (req, res) => {
    ...
    try{
      const id = req.params.id;
      const data = await songModel.deleteOne({_id:id,user_id:req.tokenData._id}, req.body);
